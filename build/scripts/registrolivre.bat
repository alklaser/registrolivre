...
@rem ##########################################################################
@rem
@rem  registrolivre startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and REGISTROLIVRE_OPTS to pass JVM options to this script.
...
@rem Execute registrolivre
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %REGISTROLIVRE_OPTS%  -classpath "%CLASSPATH%" br.com.registrolivre.App %CMD_LINE_ARGS%
...
:fail
rem Set variable REGISTROLIVRE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%REGISTROLIVRE_EXIT_CONSOLE%" exit 1
exit /b 1
