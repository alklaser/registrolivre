...
scp -i $REGISTROLIVRE_PRIVATE_KEY /Users/omachado/projects/registrolivre/infrastructure/database/scripts/postgres-uninstall.sh registrolivre@$REGISTROLIVRE_IP_OR_DNS:${DATABASE}
