...
scp -i $AWS_GO_AGENT_KEY -r ../provision/. ubuntu@$AWS_GO_AGENT_DNS:${SCRIPTS_PATH}
scp -i $AWS_GO_AGENT_KEY -r ../../configurations/. ubuntu@$AWS_GO_AGENT_DNS:${SCRIPTS_PATH}
...
ssh -i $AWS_GO_AGENT_KEY ubuntu@$AWS_GO_AGENT_DNS "sh ${SCRIPTS_PATH}/go-agent.sh $AWS_GO_AGENT_DNS"
